...
const Nav = () => {
    const{total_items}=useShortcut3()
    ...
    <Nav>
        <div className={icon?'navbar active':'navbar'}>
            <ul className='navbar-lists'>
                <li>
                    <NavLink to='/'className='navbar-link'onClick={()=>setIcon(false)} >Home</NavLink>
                </li>
                <li>
                ...
                <li>
                    <NavLink to='/singleProduct/:id'className='navbar-link'onClick={()=>setIcon(false)}>SingleProduct</NavLink>
                </li>
                <li>
            ...
            <div className='mobile-navbar-btn'>
              <CgMenu name='menu-outline' className='mobile-nav-icon' onClick={()=>setIcon(true)} />
              <CgClose name='close-outline' className='mobile-nav-icon close-outline' onClick={()=>setIcon(false)}/>
            </div>
        </div>
    </Nav>
  )
